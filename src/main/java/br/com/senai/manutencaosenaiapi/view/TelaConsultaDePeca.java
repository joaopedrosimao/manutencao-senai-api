...
public class TelaConsultaDePeca extends JFrame {
	...
	private final JLabel lblFiltro = new JLabel("Filtro");
	...
	public TelaConsultaDePeca() {
				...
				.setHorizontalGroup(
						gl_contentPane.createParallelGroup(Alignment.TRAILING).addGroup(gl_contentPane
								.createSequentialGroup().addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(lblFiltro, GroupLayout.PREFERRED_SIZE, 424,
												GroupLayout.PREFERRED_SIZE)
										.addGroup(gl_contentPane.createSequentialGroup()
												.addComponent(edtFiltro, GroupLayout.PREFERRED_SIZE, 292,
														GroupLayout.PREFERRED_SIZE)
										...
										.addComponent(scrollPane, GroupLayout.PREFERRED_SIZE, 488,
												GroupLayout.PREFERRED_SIZE)
										.addGroup(Alignment.TRAILING,
												gl_contentPane.createSequentialGroup().addContainerGap().addComponent(
														panel, GroupLayout.PREFERRED_SIZE, 223,
														GroupLayout.PREFERRED_SIZE)))
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
				gl_panel.createSequentialGroup().addContainerGap(37, Short.MAX_VALUE).addComponent(btnEditar).addGap(28)
						.addComponent(btnExcluir).addGap(22)));
