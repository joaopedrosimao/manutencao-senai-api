...
public class ClienteService {
	...
	public Cliente inserir(@Valid @NotNull(message = "O cliente não pode ser nulo") Cliente novoCliente) {
	...
	public Cliente alterar(@Valid @NotNull(message = "O cliente não pode ser nulo") Cliente clienteSalvo) {
